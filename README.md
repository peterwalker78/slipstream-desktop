...
- **Windows** that another app opens while you type wait off screen until you pause, so the window you're typing in doesn't change size and doesn't lose your next words. The bar says "*App* opened while you typed · Alt+Tab", and at the pause the window tiles beside you with a dim ring until you visit it. Windows you open yourself, dialogs of the app you're in, and programs started from it still come straight to you.
